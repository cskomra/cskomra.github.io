...
**  UpdatePositions() includes 3 optimizations:
...
function updatePositions() {
  ...
  for (var phase_count = 0; phase_count < 5; phase_count++){
    if (offset > 4){
      offset = 0;
    }
    phase[phase_count]=Math.sin((cachedScrollTop/1250)+offset);
    offset++
  }
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].style.left = items[i].basicLeft + 100 * phase[offset] + 'px';
    offset++;
  }
...
**  Create 40 pizzas rather than 200 (5 rows, 8 cols)
**  Covers all screen sizes (bottom row, img top = 1024px).
**  See table:  Global Stats Screen Sizes, 2015
**  http://www.hobo-web.co.uk/wp-content/uploads/G-ww-mar-may-2015.jpg
**
**  Add willChange style attribute with custom-ident, width.
*/
document.addEventListener('DOMContentLoaded', function() {
  ...
  var s = 256;
    ...
    elem.style.willChange = 'transform, width';
